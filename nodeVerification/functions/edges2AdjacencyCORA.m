function adjacency_tensor = edges2AdjacencyCORA(dataset)
    ...
    adjacency_tensor = zeros(num_nodes, num_nodes, 1);
    


    % disp(['Graph ' num2str(i) ' - edge indices shape: ' mat2str(size(dataset.edge_indices(:, :, i)))]);
    edges = dataset.edge_indices(:, :, 1);
